    ...
    <section className="py-16 bg-background" dir="rtl">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">مقایسه پلن‌ها</h2>
        ...
        {/* هر بخش به صورت جداگانه با اسکرول افقی مختص خودش */}
                ...
                <table className="w-full min-w-[1000px] divide-y divide-border">
                  ...
                  <tbody className="divide-y divide-border bg-background">
                    {category.rows.map((row) => (
                      ...
                      >
                        <td className="sticky right-0 z-10 bg-background px-4 py-3 text-sm font-medium">
                          {row.module}
                        </td>
