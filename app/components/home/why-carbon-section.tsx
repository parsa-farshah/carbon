  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-muted/30 overflow-hidden">
      <div className="">
        ...
        {/* موبایل: carousel */}
        <div className="lg:hidden w-full mb-12 sm:mb-16">
          <WhyCarbonCarousel features={features} />
        </div>

        {/* دسکتاپ: grid */}
        <div className="hidden lg:flex flex-row gap-5 2xl:container 2xl:mx-auto px-4 sm:px-6 lg:px-8 mb-12 sm:mb-16">
        ...
        {/* کارت‌ها */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 2xl:container 2xl:mx-auto px-4 sm:px-6 lg:px-8">
          {/* چند زبانه */}
